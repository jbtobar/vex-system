...
console.log('-----------------------------------------------------------------')
console.log('-----------------------------------------------------------------')
console.log(`cometTASFUTFIX - start - ${timenow()}`)
console.log('-----------------------------------------------------------------')
console.log('-----------------------------------------------------------------')
console.log('-----------------------------------------------------------------')
console.log('-----------------------------------------------------------------')
...
pool.connect(async function (err, client, done) {
  try {
         ...
         if (payload.length > 0) {
           if (payloadType === 'TimeAndSale' || payloadType[0] === 'TimeAndSale') {
             ...
             while (payload.length > 0) {
               ...
               // console.log(json)
               if (singleLoad[4]< 1644338700000 ) {
                   client_redis.set('LAST_FUT_K',singleLoad[4])
    ...
    publisher.subscribe('cometTASFUTFIX')
    ...
    setInterval(() => {
      console.log('cometTASFUTFIX',{messageNum,okNum,time:timenow()})
    },1000*30)
  } catch (e) {
    console.error(e)
  }
